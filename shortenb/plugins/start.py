...
async def start_command(client: Client, message: Message):
    ...
    if len(text) > 7:
        ...
        k = await client.send_message(chat_id=message.from_user.id, 
                                      text=f"<b><i>This File is deleting automatically in {file_auto_delete} to avoid copyright strikes...!</i></b>")
...
async def delete_files(messages, client, k):
    ...
    await k.edit_text("<b><i>Your File Is Successfully Deleted ✅</i></b>", reply_markup=keyboard)